    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "onlyUsername": {
                    "regex": /^[a-z0-9_-]+$/,
                    "alertText": "* Karakter yang anda masukkan tidak diperbolehkan dan hanya boleh huruf kecil"
                },
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUsernamePenggunaCall": {
                    "url": site_url+"masterdata/pengguna/checkUsernameExistence",
                    "extraDataDynamic": ['#Edit-PENGGUNA_USERNAME'],
                    "alertTextOk": "* Username Ini Tersedia",
                    "alertText": "* Username Ini Sudah Terpakai",
                    "alertTextLoad": "* Memvalidasi, Silahkan Tunggu"
                },
                "ajaxUsernameCall": {
                    "url": site_url+"profil/checkUsernameExistence",
                    "extraDataDynamic": ['#usernamePengguna'],
                    "alertTextOk": "* Username Ini Tersedia",
                    "alertText": "* Username Ini Sudah Terpakai",
                    "alertTextLoad": "* Memvalidasi, Silahkan Tunggu"
                },
                "ajaxPasswordCall": {
                    "url": site_url+"profil/checkPassword",
                    "extraDataDynamic": ['#passwordLamaPengguna'],
                    "alertTextOk": "* Password Anda Benar",
                    "alertText": "* Password yang Anda Masukkan Salah",
                    "alertTextLoad": "* Memvalidasi, Silahkan Tunggu"
                },
                "ajaxUserCall": {
