		...
		$('#PembuanganSampahTableContainer').jtable({
			...
			toolbar: {
			    items: [{
			        ...
			        click: function () {
			            var url = '<?php echo base_url()."index.php/laporan/tonase/cetaklaporantonasetanggal?tanggal="?>'+$('#tanggalTransaksi').val();
						window.open(url);
			        }
			    }]
			},
...
?>
	...
	<tr>
		<td align="left">
			<label class="control-label">Berat Bersih Timbangan</label>			
		</td>
		<td width="50px" align="center">:
		</td>
		<td>
			<div class="input-control text">
				<?php echo form_input(['name' => 'beratbersih', 'id' => 'beratbersih', 'class' => 'form-control','style'=>'width:300px;', 'value' => set_value('beratbersih'), 'placeholder' => 'Kg']); echo form_error('beratbersih');?>
			</div>
		</td>
	</tr>
