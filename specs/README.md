...
| [`16-user-manual.md`](./16-user-manual.md) | **Public user manual** (docs.swat.wahyutrip.com): Docusaurus, code-driven content, screenshots, i18n, maintenance | Frontend, docs, DevOps |
