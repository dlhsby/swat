...
class Rute_swasta extends CI_Controller{
    ...
    public function getAllRute()
    {
        ...
        $this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_all_rute($tanggal);
    ...
    public function getSepuluhRuteTerakhir(){
		$tanggal=$this->input->post('tanggal');
        $this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_sepuluh_rute_terakhir($tanggal);
    ...
    public function getLimaRuteTerakhir(){
		$tanggal=$this->input->post('tanggal');
        $this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_lima_rute_terakhir($tanggal);
    ...
    public function getRuteAntarSpot(){
        ...
        $this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_rute_antar_spot($nopol,$tanggal);

        echo json_encode($result->result());
    }
	public function getLocationTPA(){
		$this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_location_tpa();
    ...
    public function getTotalJenisKendaraanAktif(){
		$tanggal=$this->input->post('tanggal');
        $this->load->model('model_monitoringrute_swasta');
        $result = $this->model_monitoringrute_swasta->get_total_jenis_kendaraan_aktif($tanggal);
