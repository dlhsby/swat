function getTotalJenisSampah(tanggal){
	try{
	    ...
	    $.ajax({
	        ...
	        type: "POST",
	        url: base_url+"index.php/monitoring/tonase/getTonaseJenisSampah",
	        async: false,
	        dataType: 'json',
...
function getTonaseLimaHariTPS(tanggal) {
    ...
    $.ajax({
		data: {tanggal: tanggal},
        type: "POST",
        url: base_url+"index.php/monitoring/tonase/getTonaseLimaHariTPS",
        dataType: "json",
        async: false,
        success: function (data) {
...
function getNamaTonaseLimaHariTPS(tanggal) {
    try{
	    ...
	    $.ajax({
			data: {tanggal: tanggal},
	        type: "POST",
	        url: base_url+"index.php/monitoring/tonase/getNamaTonaseLimaHariTPS",
	        dataType: "json",
	        async: false,
	        success: function (data) {
...
function getTonaseLimaHariTotal(tanggal) {
    ...
    $.ajax({
		data: {tanggal: tanggal},
        type: "POST",
        url: base_url+"index.php/monitoring/tonase/getTotalTonaseLimaHari",
        dataType: "json",
        async: false,
        success: function (data) {
            datatabel = data;
...
function getTonaseSatuBulanTotal(tanggal) {
    ...
    $.ajax({
		data: {tanggal: tanggal},
        type: "POST",
        url: base_url+"index.php/monitoring/tonase/getTotalTonaseSatuBulan",
        dataType: "json",
        async: false,
        success: function (data) {
            datatabel = data;
...
function getTonaseSatuBulanTotalPerKategoriSumberSampah(tanggal) {
    try{
		var datatabel;
    $.ajax({
		data: {tanggal: tanggal},
        type: "POST",
        url: base_url+"index.php/monitoring/tonase/getTotalTonaseSatuBulanPerKategoriSumberSampah",
        dataType: "json",
        async: false,
        success: function (data) {
            datatabel = data;
...
function loadTotalTonaseSatuBulanPerKategoriSumberSampah(tanggal){
	try{	    //tonase lima hari total
	    datatabel = getTonaseSatuBulanTotalPerKategoriSumberSampah(tanggal);
		$('#tonaseSatuBulanTotalPerKategoriSumberSampah').html("");
	    new Morris.Bar({
	        element: 'tonaseSatuBulanTotalPerKategoriSumberSampah',
	        data: datatabel,
	        xkey: 'TANGGAL',
	        ykeys: ['BERATSAMPAH_DINAS','BERATSAMPAH_NONDINAS'],
	        labels: ['BERAT SAMPAH DINAS', 'BERAT SAMPAH NON DINAS'],
	        barColors: ['#79D1CF', '#E67A77']
	    });
	} catch (err) {
		console.log("tidak bisa menampilkan tonase satu bulan total");
	}
...
function updateTotalTonaseSatuBulanPerKategoriSumberSampah(tanggal){
