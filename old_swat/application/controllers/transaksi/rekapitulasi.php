...
class Rekapitulasi extends CI_Controller{
	...
	public function index(){
		$this->auth->restrict();
		$this->auth->cek_menu(94);
		
		$this->template->set('title','Rekapitulasi Kendaraan | SWAT DKP');
		$this->template->load('template','transaksi/rekapitulasi/index');
	}
	
	public function hari(){
		$this->auth->restrict();
		$this->auth->cek_menu(95);
		...
		$this->template->set('title','Rekapitulasi Kendaraan | SWAT DKP');
		$this->template->load('template','transaksi/rekapitulasi/hari/index',$data);
	}
	
	public function getrekapitulasihari(){
		$this->auth->restrict();
		$this->auth->cek_menu(95);
	...
	public function getrekapitulasiharibyfilter(){
		$this->auth->restrict();
		$this->auth->cek_menu(95);
		...
		$all_rekapitulasi = $this->model_haritransaksi->get_all_haritransaksi_by_filter($tanggalHariTransaksi,$statusHariTransaksi);
	...
	public function transaksi(){
		...
		$this->template->set('title','Rekapitulasi Kendaraan | SWAT DKP');
		$this->template->load('template','transaksi/rekapitulasi/transaksi/index',$data);
	}
	...
	public function getrekapitulasitransaksi(){
		...
		$all_rekapitulasiTransaksi = $this->model_transaksiangkutsampah->get_all_transaksiangkutsampah();
		$result = $this->model_transaksiangkutsampah->get_all_paging_sorting_transaksi($jtStartIndex,$jtPageSize,$jtSorting);
		
		$rows = $result->result_array();
		$recordCount = $all_rekapitulasiTransaksi->num_rows();
	...
	public function getrekapitulasitransaksibyfilter(){
		$this->auth->restrict();
		$this->auth->cek_menu(96);
		...
		$all_rekapitulasiTransaksi = $this->model_transaksiangkutsampah->get_all_transaksiangkutsampah_by_filter($tanggalHariTransaksi,$nomorPolisiKendaraan,$aplikasiKendaraan,$kategoriKendaraan,$poolKendaraan,$kodeKendaraan,$statusTransaksi);
	...
	public function createrekapitulasitransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(96);
		$this->load->model('model_transaksiangkutsampah');
	...
	public function updaterekapitulasitransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(96);
		$this->load->model('model_transaksiangkutsampah');
	...
	public function deleterekapitulasitransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(96);
	...
	public function detailtransaksi(){
		...
		$this->template->set('title','Rekapitulasi Kendaraan | SWAT DKP');
		$this->template->load('template','transaksi/rekapitulasi/detailtransaksi/index',$data);
	}

	public function getrekapitulasidetailtransaksibyfilter(){
		$this->auth->restrict();
		$this->auth->cek_menu(97);
		...
		$all_rekapitulasiDetailTransaksi = $this->model_detailtransaksiangkutsampah->get_all_detailtransaksiangkutsampah_with_pengemudi_and_statusdetailtransaksiangkutsampah_and_transaksiangkutsampah_by_filter($transaksiID,$statusDetailTransaksi);
		...
		$rows = $result->result_array();
		$recordCount = $all_rekapitulasiDetailTransaksi->num_rows();
	...
	public function createrekapitulasidetailtransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(97);
		$this->load->model('model_detailtransaksiangkutsampah');
		...
		$data_detailtransaksiangkutsampah = array(
			...
			'DETAILTRANSAKSIANGKUTSAMPAH_REKAPKMREALISASIBERANGKATKANDANG' => $this->input->post('DETAILTRANSAKSIANGKUTSAMPAH_REKAPKMREALISASIBERANGKATKANDANG'),
			'DETAILTRANSAKSIANGKUTSAMPAH_REKAPKMREALISASIKEMBALIKANDANG' => $this->input->post('DETAILTRANSAKSIANGKUTSAMPAH_REKAPKMREALISASIKEMBALIKANDANG'),
			'DETAILTRANSAKSIANGKUTSAMPAH_REKAPWAKTUREALISASIBERANGKATKANDANG' => $this->input->post('DETAILTRANSAKSIANGKUTSAMPAH_REKAPWAKTUREALISASIBERANGKATKANDANG'),
			'DETAILTRANSAKSIANGKUTSAMPAH_REKAPWAKTUREALISASIKEMBALIKANDANG' => $this->input->post('DETAILTRANSAKSIANGKUTSAMPAH_REKAPWAKTUREALISASIKEMBALIKANDANG'),
	...
	public function updaterekapitulasidetailtransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(97);
		$this->load->model('model_detailtransaksiangkutsampah');
	...
	public function deleterekapitulasidetailtransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(97);
	...
	public function trayek(){
		...
		$this->template->set('title','Rekapitulasi Kendaraan | SWAT DKP');
		$this->template->load('template','transaksi/rekapitulasi/trayek/index',$data);
	}
	
	public function getrekapitulasitrayekbyfilter(){
		$this->auth->restrict();
		$this->auth->cek_menu(98);
		...
		$all_rekapitulasiTrayek = $this->model_trayek->get_all_trayek_with_detailtransaksiangkutsampah_and_rute_and_statustrayek_by_filter($detailTransaksiID,$statusTrayek);
		...
		$rows = $result->result_array();
		$recordCount = $all_rekapitulasiTrayek->num_rows();
	...
	public function createrekapitulasitrayek(){
		$this->auth->restrict();
		$this->auth->cek_menu(98);
		$this->load->model('model_trayek');
		...
		$data_trayek = array(
			...
			'TRAYEK_JUMLAHISIBBMDISETUJUI' => $this->input->post('TRAYEK_JUMLAHISIBBMDISETUJUI'),
			...
			'TRAYEK_WAKTUENTRIREALISASI' => $waktuSekarangHariIni,
		);
	...
	public function updaterekapitulasitrayek(){
		$this->auth->restrict();
		$this->auth->cek_menu(98);
		$this->load->model('model_trayek');
		$this->load->model('model_rute');
	...
	public function deleterekapitulasitrayek(){
		$this->auth->restrict();
		$this->auth->cek_menu(98);
	...
	public function getrekapitulasitransaksibyharitransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(96);
		...
		$all_rekapitulasiTransaksi = $this->model_transaksiangkutsampah->get_transaksiangkutsampah_by_haritransaksi_id_with_haritransaksi_kendaraan_statustransaksi($hariTransaksiID);
	...
	public function getrekapitulasidetailtransaksibytransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(97);
		...
		$all_rekapitulasiDetailTransaksi = $this->model_detailtransaksiangkutsampah->get_detailtransaksiangkutsampah_by_transaksiangkutsampah_id_with_pengemudi_and_masterdetailtransaksiangkutsampah_and_statusdetailtransaksiangkutsampah_and_transaksiangkutsampah($transaksiID);
	...
	public function getrekapitulasitrayekbydetailtransaksi(){
		$this->auth->restrict();
		$this->auth->cek_menu(98);
		...
		$all_rekapitulasiTrayek = $this->model_trayek->get_trayek_by_detailtransaksiangkutsampah_id_with_detailtransaksiangkutsampah_and_rute_and_statustrayek($trayekID);
