function loadTotalJenisKendaraanAktif(tanggal){
	try{
	    ...
	    $.ajax({
	        ...
	        type: "POST",
	        url: base_url+"index.php/monitoring/rutesemua/getTotalJenisKendaraanAktif",
	        async: false,
	        dataType: 'json',
...
function getAllRute(tanggal) {
	try{
	    ...
	    $.ajax({
			data: {tanggal: tanggal},
	        type: "POST",
	        url: base_url+"index.php/monitoring/rutesemua/getAllRute",
	        dataType: "json",
	        async: false,
	        success: function (data) {
	            $.each(data, function(i,item){
...
function getRuteAntarSpot(data,tanggal){
	try{
		$.ajax({
	        ...
	        type: "POST",
	        url: base_url+"index.php/monitoring/rutesemua/getRuteAntarSpot",
	        dataType: "json",
	        async: false,
	        success: function (data) {
	            console.log(data[0]);
...
function getLocationTPA(){
	try{
		$.ajax({
	        type: "POST",
	        url: base_url+"index.php/monitoring/rutesemua/getLocationTpa",
	        dataType: "json",
	        async: false,
	        success: function (data) {
				console.log("tpa");
