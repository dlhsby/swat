...
/**
 * Per-refuel ledger (litres / estimated cost / anomaly history), derived from
 * refuel-type trips. Extracted from the former standalone /refuel-log page so it
 * can live as the "Riwayat Pengisian" tab inside Konsumsi BBM monitoring while the
 * /refuel-log route keeps working for deep links.
 */
export function RefuelLogPanel(): JSX.Element {
