...
const ENV: Env = {
  ...
  GPS_GEOFENCE_DEFAULT_RADIUS_M: 100,
  ...
  GASIFICATION_ENABLED: false,
  GASIFICATION_BASE_URL: 'https://tpa.sidigital.co.id',
  GASIFICATION_API_KEY: undefined,
  GASIFICATION_PHOTO_BASE_URL: 'https://fotoarmada.sidigital.co.id/gasifikasi/',
  GASIFICATION_PULL_INTERVAL_MIN: 10,
  GASIFICATION_LOOKBACK_DAYS: 2,
  GASIFICATION_MATCH_BEFORE_MIN: 30,
  GASIFICATION_MATCH_AFTER_MIN: 120,
  GASIFICATION_MAX_REQUESTS_PER_MIN: 60,
  GASIFICATION_REQUERY_COOLDOWN_MIN: 60,
};
